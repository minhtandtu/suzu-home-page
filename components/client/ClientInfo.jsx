      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mb-6 text-sm font-normal text-gray-900 md:mb-8 md:max-w-3xl md:text-xl">
          <p>
            ...
            đầu tư của chúng tôi tự nói lên điều đó, nhưng rất nhiều dự án trong
            quá khứ và hiện tại của chúng tôi sẽ không thể được tạo ra nếu không
            có những khách hàng danh sách đáng kinh ngạc của chúng tôi. Mọi
            thiết kế tuyệt vời đều bắt đầu bằng một câu chuyện thậm chí còn hay
            hơn, nhưng nếu không có khách hàng, sẽ không có câu chuyện nào để
            kể.
            <br />
            <br /> Studio của chúng tôi luôn phát triển mạnh nhờ sự hợp tác cởi
            mở và tìm tòi sáng tạo và chúng tôi may mắn có được một số cơ hội
            làm việc với danh sách khách hàng tuyệt vời luôn sẵn sàng thúc đẩy
            con thuyền.
          </p>
        </div>
      </div>
